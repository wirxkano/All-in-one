...
class DatasetBlindSR(data.Dataset):
    ...
    def __init__(self, opt):
        ...
        self.degradation_model = DegradationModel(SETTINGS)
...
#        time.sleep(1)
    ...
    def __getitem__(self, index):
        ...
        if self.opt['phase'] == 'train':
            ...
            elif self.degradation_type == 'region_dependent':
                img_H = util.single2tensor3(img_H)
                img_L = self.degradation_model.random_shuffle_degradations(
                    img_H.unsqueeze(0), scale_factor=0.25
                )
        ...
        # ------------------------------------
        if self.degradation_type != 'region_dependent':
