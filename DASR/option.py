...
# Data specifications
parser.add_argument(
    "--dir_data", type=str, default="D:/LongguangWang/Data", help="dataset directory"
)
parser.add_argument(
    "--val_path",
    type=str,
    default="D:/LongguangWang/Data",
...
parser.add_argument("--data_test", type=str, default="Set14", help="test dataset name")
parser.add_argument(
    "--data_range", type=str, default="1-3450/801-810", help="train/test data range"
)
...
parser.add_argument(
    "--mode", type=str, default="bicubic", help="downsampler (bicubic | s-fold)"
)
...
parser.add_argument(
    "--sig", type=float, default=4.0, help="specific sigma of isotropic Gaussian blurs"
)
...
parser.add_argument("--model", default="blindsr", help="model name")
parser.add_argument(
...
parser.add_argument(
    "--lr_sr", type=float, default=1e-4, help="learning rate to train the whole network"
)
parser.add_argument(
    "--lr_decay_encoder", type=int, default=60, help="learning rate decay per N epochs"
)
parser.add_argument(
    "--lr_decay_sr", type=int, default=125, help="learning rate decay per N epochs"
)
parser.add_argument(
...
# Log specifications
parser.add_argument("--save", type=str, default="blindsr", help="file name to save")
parser.add_argument("--load", type=str, default=".", help="file name to load")
parser.add_argument(
    "--resume", type=int, default=0, help="resume from specific checkpoint"
)
parser.add_argument(
...
parser.add_argument("--save_results", default=False, help="save output results")
